...
Whenever content in the repository's listed branches/tags are changed, the GitHub Action sends a link:{url-netlify-docs}/configure-builds/build-hooks/[build hook] to Netlify to trigger a new build of the staging site.
