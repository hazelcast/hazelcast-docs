...
+++ <iframe height="400px" width="100%" src="https://repl.it/@jake91/hazelcast-cloud-java-sample-client?lite=true" scrolling="no" frameborder="no" allowtransparency="true" allowfullscreen="true" sandbox="allow-forms allow-pointer-lock allow-popups allow-same-origin allow-scripts allow-modals"></iframe> +++
...
* Form a cluster not just on your local machine: see xref:deploy:setting_up_clusters.adoc[Setting Up Clusters].
* Start using our distributed data structures: see xref:reference:distributed_data_structures.adoc[Distributed Data Structures].
* Learn how to configure Hazelcast IMDG: see xref:reference:understanding_configuration.adoc[Understanding Configuration].
