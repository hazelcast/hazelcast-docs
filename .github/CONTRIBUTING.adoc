...
<4> The https://docs.antora.org/antora/2.3/asciidoc/link-attachment[`attachments/` folder] contains downloadable content such as ZIP files that a user can download through a link. To include a download link, use the following syntax: `link:path/to/example.zip[Download the example]`
<5> The https://docs.antora.org/antora/2.3/page/examples-and-source-snippets[`examples/` folder] contains examples such as source code that you can include in Asciidoc pages, using the following syntax: `include::example$example-filename.json[]`
<6> The https://docs.antora.org/antora/2.3/page/images[`images/` folder] contains images that you can include in Asciidoc pages, using the following syntax: `image::path/to/image[Alt text]` for block images and `image:path/to/image[Alt text]` for inline images
